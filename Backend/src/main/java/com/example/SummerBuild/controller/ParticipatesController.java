...
public class ParticipatesController {
    ...
    public ResponseEntity<ParticipatesDto> registerEvent(
            @RequestBody ParticipatesDto request) {
        try {
            logger.info("POST /api/participates/register - Registering user : {} to event : {}", 
                       request.getUserId(), request.getEventId());
            ParticipatesDto participation = participatesService.addParticipation(request.getUserId(), request.getEventId());
    ...
    public ResponseEntity<Void> unregisterEvent(
            @RequestBody ParticipatesDto request) {
        try {
    ...
    @Operation(summary = "Get user participations", description = "Get all events a user is participating in")
    ...
    @GetMapping("/check")
    @Operation(summary = "Check participation", description = "Check if a user is participating in an event")
    ...
    @Operation(summary = "Get participant count", description = "Get the number of participants for an event")
    ...
    @Operation(summary = "Get user event count", description = "Get the number of events a user is participating in")
    ...
    @GetMapping
    @Operation(summary = "Get all participations", description = "Get all participations in the system")
